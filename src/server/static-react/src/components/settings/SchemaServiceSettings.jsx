  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card card-info p-3">
        <p className="text-xs text-secondary">
          <strong>Note:</strong> Schema service configuration is set at server startup via the <code className="text-gruvbox-blue">--schema-service-url</code> flag or environment variable.
        </p>
      </div>
    </div>
  )
