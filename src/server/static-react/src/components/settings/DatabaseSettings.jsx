      ...
      <div className="space-y-4">
        ...
        {dbType === 'dynamodb' && (
          <div className="space-y-3">
            ...
            <div className="card card-warning p-3"><p className="text-xs text-warning"><strong>Note:</strong> Ensure AWS credentials are configured.</p></div>
          </div>
        )}
        ...
        <div className="mt-8 pt-6 border-t border-error">
          ...
          {!isResetting ? (
            ...
            <div className="card card-info p-3 flex items-center gap-2 text-sm text-info"><span className="spinner" /> Resetting Database...</div>
          )}
          {resetResult && (
            <div className={`mt-4 p-3 text-sm card ${resetResult.type === 'success' ? 'card-success text-success' : 'card-error text-error'}`}>
              {resetResult.message}
            </div>
          )}
        </div>
