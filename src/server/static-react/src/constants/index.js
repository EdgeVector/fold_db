...
import {
  ...
  RANGE_SCHEMA_CONFIG as _RANGE_SCHEMA_CONFIG,
} from "./schemas";
...
import {
  DEFAULT_TABS as _DEFAULT_TABS,
  BUTTON_TEXT as _BUTTON_TEXT,
  FORM_LABELS as _FORM_LABELS,
  UI_STATES as _UI_STATES,
} from "./ui.js";
...
export const DEFAULT_TAB = "smart-folder"; // Direct constant to avoid undefined issues
