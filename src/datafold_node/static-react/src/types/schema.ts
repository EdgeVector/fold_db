...
// Note: DeclarativeSchemaType and KeyConfig should be generated by ts-rs from Rust
// but for now we define them manually to match the backend structure

/**
 * Key configuration for Range and HashRange schemas
 */
...
/**
 * Schema type enum matching Rust DeclarativeSchemaType
 */
export type DeclarativeSchemaType = 
  | 'Single'
  | { Single: {} }
