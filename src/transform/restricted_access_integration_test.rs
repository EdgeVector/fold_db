...
mod tests {
    ...
    fn test_transform_restricted_access_with_test_db() {
        ...
        fixture.cleanup().expect("Failed to clean up test database");
    ...
    fn test_database_cleanup() {
        ...
        let fixture =
            TransformRestrictedAccessTestFixture::new().expect("Failed to create test fixture");
