...
use crate::transform::shared_utilities::{
    collect_expressions_from_schema_with_keys, convert_iterator_stack_error,
...
fn execute_with_engine(
    ...
    let execution_result = execution_engine
        .execute_fields(&chains_only, alignment_result, input_data.clone())
    ...
    info!(
        "📈 Enhanced ExecutionEngine produced {} index entries, {} warnings",
