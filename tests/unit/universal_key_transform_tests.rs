...
mod tests {
    ...
    fn test_universal_key_field_processing() {
        ...
        let (hash_field, range_field) = fixture
            .mutation_service
        ...
        let range_field_name = fixture
            .mutation_service
            .get_range_key_field_name(&range_schema)
            .unwrap();
    ...
    fn test_universal_key_error_handling() {
        ...
        let result = fixture
            .mutation_service
            .get_hashrange_key_field_names(&schema_no_key);
        assert!(result.is_err());
        assert!(result
            .unwrap_err()
            .to_string()
            .contains("requires key configuration"));
        ...
        let result = fixture
            .mutation_service
            .get_hashrange_key_field_names(&schema_empty_key);
        assert!(result.is_err());
        assert!(result
            .unwrap_err()
            .to_string()
            .contains("requires non-empty hash_field"));
