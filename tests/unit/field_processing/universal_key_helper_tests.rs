...
use datafold::fold_db_core::managers::atom::field_processing::{ResolvedAtomKeys, resolve_universal_keys};
use datafold::schema::types::{Schema, SchemaType, FieldVariant};
use datafold::schema::types::field::{SingleField, RangeField, HashRangeField};
...
fn test_resolve_universal_keys_single_no_key() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestSingle", &request_payload).unwrap();
...
fn test_resolve_universal_keys_single_with_key() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestSingleKey", &request_payload).unwrap();
...
fn test_resolve_universal_keys_range_legacy() {
    ...
    let schema = Schema {
        ...
        fields: {
            let mut fields = HashMap::new();
            fields.insert("content".to_string(), FieldVariant::Range(RangeField::new(
                PermissionsPolicy::default(),
                FieldPaymentConfig::default(),
                HashMap::new(),
            )));
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestRangeLegacy", &request_payload).unwrap();
...
fn test_resolve_universal_keys_range_universal() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestRangeUniversal", &request_payload).unwrap();
...
fn test_resolve_universal_keys_hashrange() {
    ...
    let schema = Schema {
        ...
        fields: {
            let mut fields = HashMap::new();
            fields.insert("content".to_string(), FieldVariant::HashRange(Box::new(HashRangeField::new(
                PermissionsPolicy::default(),
                FieldPaymentConfig::default(),
                HashMap::new(),
                "user_id".to_string(),
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestHashRange", &request_payload).unwrap();
...
fn test_resolve_universal_keys_dotted_path() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestDottedPath", &request_payload).unwrap();
...
fn test_resolve_universal_keys_missing_schema() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "NonExistentSchema", &request_payload);
...
fn test_resolve_universal_keys_missing_key_data() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestMissingKeyData", &request_payload);
...
fn test_resolve_universal_keys_empty_key_config() {
    ...
    let result = resolve_universal_keys(&fixture.atom_manager, "TestEmptyKeyConfig", &request_payload);
