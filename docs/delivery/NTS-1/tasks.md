# Tasks for PBI NTS-1: Native Rust Data Types for Transforms

This document lists all tasks associated with PBI NTS-1.

**Parent PBI**: [PBI NTS-1: Native Rust Data Types for Transforms](./prd.md)
...
| NTS-1-8 | [E2E CoS Test](./NTS-1-8.md) | Proposed | End-to-end validation of all acceptance criteria |
