# Tasks for PBI NTS-6: Native Persistence with Minimal JSON Usage

This document lists all tasks associated with PBI NTS-6.

**Parent PBI**: [PBI NTS-6: Native Persistence with Minimal JSON Usage](./prd.md)
...
| NTS-6-6 | [Update documentation](./NTS-6-6.md) | Proposed | Document all persistence operations and usage |
| NTS-6-7 | [E2E CoS Test](./NTS-6-7.md) | Proposed | End-to-end validation of all acceptance criteria |
