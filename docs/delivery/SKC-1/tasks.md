...
| SKC-1-4 | [UI helpers support universal key and consistent detection](./SKC-1-4.md) | Review | Update UI utilities to read optional key on Single/Range and required on HashRange. |
