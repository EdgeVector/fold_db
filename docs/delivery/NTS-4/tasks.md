# Tasks for PBI NTS-4: Native Data Processing Pipeline

This document lists all tasks associated with PBI NTS-4.

**Parent PBI**: [PBI NTS-4: Native Data Processing Pipeline](./prd.md)
