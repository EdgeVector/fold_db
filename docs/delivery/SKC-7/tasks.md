# Tasks for PBI SKC-7: Update Aggregation Utilities for Universal Key Configuration

This document lists all tasks associated with PBI SKC-7.

**Parent PBI**: [PBI SKC-7: Update Aggregation Utilities for Universal Key Configuration](./prd.md)

## Task Summary

| Task ID | Name                                     | Status   | Description                        |
| :------ | :--------------------------------------- | :------- | :--------------------------------- |
| SKC-7-1 | [Integrate universal key configuration into aggregation pipeline](./SKC-7-1.md) | In Review/Complete | Replace hardcoded key handling in aggregation with schema-driven universal key utilities. |
